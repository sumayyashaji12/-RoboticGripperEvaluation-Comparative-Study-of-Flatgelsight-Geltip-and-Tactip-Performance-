...
if __name__ == "__main__":
    ...
    with open('experiment_results.csv', mode='a', newline='') as csv_file:
        ...
        if file_is_empty:
            ...
            # Iterate over the defined parameters to perform the experiment
        for force in close_gripper_forces:
          for amp in shake_gripper_amplitudes:
             for xyz in force_move_xyz_values:
                for _ in range(5):
                    # Execute the grasp routine with the specified parameters
                    ...
                    sim.reset_state(include=['object', 'gripper', 'plane'], object_urdf_path=object_urdf_path)
                    # Reset the camera view in the simulation
                ...
                # Reset the success count and total attempts for the next iteration   
