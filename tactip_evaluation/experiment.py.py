...
if __name__ == "__main__":
    ...
    gripper_name = 'tactip_gripper'
    object_name = 'cube'
    close_gripper_forces = range(30, 40, 50 )
    shake_gripper_amplitudes = [0.0, 0.1, 0.3]
    force_move_xyz_values = [[0.00,0.0,0.128],[0.005,0.0,0.130]]  #for x in np.arange(-0.05, 0.051, 0.01)
